...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
  <a href="/data/2025-03-31/2025-03-31-identity.json" class="button-blue"><IdentityIcon class='inline-block mr-2' /> Identity JSON </a>
  <a href="/data/2025-03-31/2025-03-31-payment.json" class="button-blue"><PayIcon class='inline-block mr-2' /> Payment JSON </a>
  <a href="/data/2025-03-31/2025-03-31-exchange.json" class="button-blue"><DataIcon class='inline-block mr-2' /> Exchange JSON </a>
</div>
