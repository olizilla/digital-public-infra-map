...
### Digital Public Infrastructure: Regulation, Impact, and Future Directions

_September 17th 13:00 - 14:30 BST_ - The meeting is on Zoom. [Register here to attend](https://ucl.zoom.us/meeting/register/I2BL1TbORXm_Zfbe9F69-g#/registration)

This interactive 90-minute session will explore critical challenges and opportunities surrounding DPI implementation, regulation and governance. Drawing on insights from the recent [Cambridge Centre for Alternative Finance](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/) report on [Digital Public Infrastructure and Digital Financial Services](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/digital-public-infrastructure-and-digital-financial-services/), we'll examine the complex landscape of cross-regulatory governance and explore how jurisdictions can overcome regulatory fragmentation and coordination gaps.

The session will focus on two key areas: effective coordination mechanisms for building more coherent DPI governance frameworks, and emerging disruptive trends reshaping the DPI landscape. We'll gather insights on how DPI can enable citizen development and support socio-economic changes while maintaining security and public trust.

No prior familiarity with financial systems is required. Participants are encouraged to engage, share insights, and ask questions. 

This session will follow Chatham House Rules and so will not be recorded. A detailed and anonymised written summary of the discussion will be provided following the event.
