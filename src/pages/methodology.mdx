...
import IndicatorsTable from '../components/IndicatorTable.astro';
...
<div class="text-center py-4"><a href="https://www.ucl.ac.uk/bartlett/sites/bartlett/files/dpi_conceptualisation_and_measurement.pdf" class="button-blue">Download the PDF</a></div>
...
## DPI Indicators for Digital Identity 

<IndicatorsTable dpi='id' />

## DPI Indicators for Digital Payment Systems

<IndicatorsTable dpi='pay' />

## DPI Indicators for Data Exchange Systems

<IndicatorsTable dpi='data' />
